 ...
 */
import { AuthUser, AuthSession, AuthResult, SignUpCredentials, SignInCredentials, PasswordResetRequest, PasswordUpdateRequest, UserProfileUpdate } from '../types/auth';
/**
...
export interface AuthProvider {
     ...
     */
    verifyPasswordResetToken(token: string): Promise<AuthResult<{
        email: string;
    }>>;
    /**
